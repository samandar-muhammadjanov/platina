...
PopularPosts popularPostsFromJson(String str) =>
    PopularPosts.fromJson(json.decode(str));

String popularPostsToJson(PopularPosts data) => json.encode(data.toJson());
...
class PopularPosts {
  ...
  factory PopularPosts.fromJson(Map<String, dynamic> json) => PopularPosts(
        count: json["count"],
        next: json["next"],
