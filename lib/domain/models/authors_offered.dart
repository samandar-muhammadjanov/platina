...
AuthorsOffered authorsOfferedFromJson(String str) =>
    AuthorsOffered.fromJson(json.decode(str));

String authorsOfferedToJson(AuthorsOffered data) => json.encode(data.toJson());

class AuthorsOffered {
  int count;
  String next;
  dynamic previous;
  List<Result> results;
  ...
  factory AuthorsOffered.fromJson(Map<String, dynamic> json) => AuthorsOffered(
        count: json["count"],
        next: json["next"] ?? "",
